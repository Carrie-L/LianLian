...
import com.carrie.lianlian.utils.DisplayUtil;
...
public class CircleView extends View {
    ...
    private  int mSH = App.mScreenHeight-180;//减去toolbar和状态栏的高度，让它往上一点
    /**
     * 设置小圆半径,dp
     **/
    private static final int RADIUS_SMALL = 96;
    /**
    ...
    private void setPaint() {
        ...
        mPaintBigCircle.setStrokeWidth(2);
        ...
        mPaintText.setTextSize(DisplayUtil.sp2px(mContext, 16));
    }
...
//                LogUtil.i(TAG, "onTouchEvent: ACTION_DOWN  mTouchX=" + mTouchX + ",mTouchY=" + mTouchY);
    ...
    private void setListener(int pos){
        mClickListener.onClick(pos,colors[pos]);
    }
